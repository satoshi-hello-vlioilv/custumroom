...
const PRESETS = [
  // ===== アルミ製造工場 (デフォルト) =====
  {
    ...
    items: [
      ...
      // ===== 炉前 原材料待機パレット (x=-8〜-2, z=-8〜-6) =====
      P('steelpallet', -7.0, -7.5, 0),
      P('steelpallet', -5.0, -7.5, 0),
      P('alumcoil',    -6.5, -6.5, 0),

      // ===== スクラップ回収 =====
      P('scrpbucket',  -5.0, -7.5, 0),   // 炉ゾーン
      P('scrpbucket',  +2.5, -5.0, 0),   // プレスゾーン
      P('scrpbucket', +10.0, -5.0, 0),   // CNCゾーン

      // ===== 作業者 =====
      P('worker',  -5.0, -7.5, 0),       // 炉前作業者
      ...
      P('steelpallet', -13.0, +6.5, 0),
      P('steelpallet', -11.5, +6.5, 0),
      P('steelpallet', -10.0, +6.5, 0),
      P('drum',     -13.0, +8.0, 0),
      P('drum',     -11.5, +8.0, 0),
      ...
      P('steelpallet', +11.0, +2.5, 0),
      P('steelpallet', +11.0, +5.0, 0),
