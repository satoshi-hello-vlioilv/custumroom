...
const PRESETS = [
  ...
  },
  {
    ...
    items: [
      ...
      P('locker', -8.3, 3.8, 90, '#c0b8a8'),
      P('locker', -8.3, 5.0, 90, '#c0b8a8'),
      P('monstera', -6.5, 5.5),
  ...
  },
  {
    ...
    items: [
      ...
      P('ctrlpanel', -3.2, 4.6, 180, '#e8e2d6'),  // 南壁に背面→管理室内向き
  ...
  },
  {
    ...
    items: [
      ...
      P('closet', 5.0, -2.4, 180, '#f3ece0'), P('zzplant', 2.6, -2.9),  // dbedとの重なりを解消
