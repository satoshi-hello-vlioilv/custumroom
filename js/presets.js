...
const PRESETS = [
  ...
  },
  {
    ...
    items: [
      ...
      P('ctable',     -4.0,  1.9),
      // 執務エリア (左)
      P('desk',  -5.5, -0.5, 180, '#f3ece0'), P('ochr', -5.5, 0.2, 180),
      P('desk',  -5.5, -2.0, 180, '#f3ece0'), P('ochr', -5.5,-1.3, 180),
      P('desk',  -5.5, -3.5, 180, '#f3ece0'), P('ochr', -5.5,-2.8, 180),
      P('desk',  -2.5, -0.5,   0, '#f3ece0'), P('ochr', -2.5,-1.2,   0),
      P('desk',  -2.5, -2.0,   0, '#f3ece0'), P('ochr', -2.5,-2.7,   0),
      P('desk',  -2.5, -3.5,   0, '#f3ece0'), P('ochr', -2.5,-4.2,   0),
